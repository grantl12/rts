...
UNIT_UPGRADES = {
    "regency": [
        ...
        },
        {
            "id":       "upg_motorpool",
            "name":     "MOTORPOOL AUT.",
            "desc":     "GRAVY SEAL → PROUD PERIMETER",
            "cost":     500,
            "base":     "gravy_seal",
            "upgraded": "proud_perimeter",
            "requires": "reg_depot",
        },
    ],
    "frontline": [
        ...
        },
        {
            "id":       "upg_signal_boost",
            "name":     "SIGNAL BOOST",
            "desc":     "DRONE SCOUT → ASSAULT",
            "cost":     450,
            "base":     "drone_scout",
            "upgraded": "drone_assault",
            "requires": "fl_drone",
        },
    ],
    "sovereign": [
        ...
        {
            "id":       "upg_interpreter_kit",
            "name":     "FIELD KIT",
            "desc":     "INTERPRETER → SETTLER",
            "cost":     300,
            "base":     "interpreter",
            "upgraded": "settler",
            "requires": "sov_safehouse",
        },
    ],
    "oligarchy": [
        {
        ...
        {
            "id":       "upg_executive_package",
            "name":     "EXECUTIVE PKG",
            "desc":     "CONTRACTOR → DIREKTOR",
            "cost":     800,
            "base":     "contractor",
            "upgraded": "direktor",
            "requires": "olig_hq",
