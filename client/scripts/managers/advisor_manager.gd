...
const _LINES := {
	"Regency": {
		...
		"runner_ambush":      "Director — hostiles have mobilized around the High-Value Person's location. Recommend immediate interdiction. Every second of delay is a liability.",
	...
	"Oligarchy": {
		...
		"runner_ambush":      "Resistance assets are converging on the subject's position. Prioritise recovery. The market does not wait.",
	...
	"Frontline": {
		...
		"runner_ambush":      "Contact! They're protecting the subject — this is exactly what they want us to see. Keep recording. This is the story.",
	...
	"Sovereign": {
		...
		"runner_ambush":      "They have guards. Expected. The zone does not negotiate — push through.",
